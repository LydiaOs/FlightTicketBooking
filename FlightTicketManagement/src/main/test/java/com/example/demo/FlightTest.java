 ...
 */
	...
	BigInteger flightId=BigInteger.valueOf(1L);
	 @Test()
	  public final void testEquals() throws NullPointerException {
		  ...
		  assertNotNull(f1);
		  Flight f2=null;
		  Flight f3= new Flight(flightId,"SpiceJet","AUI89",200,"xxx","yyy");
		  Flight f4= new Flight(flightId,"SpiceJet","AUI89",200,"xxx","ccc");
	...
	{
		Flight flight=new Flight(flightId,"AirIndia","A1111",200,"jjj","vvv");
	...
	@Test
	  public final void testToString() {
		  Flight f1= new Flight(flightId,"SpiceJet","A45RT",200,"ccc","nnn");
